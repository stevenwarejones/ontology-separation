...
def write_examples(report, directory):
    ...
    (directory/'index.html').write_text(shell('Ontology Separation examples', '<h1>Ontology Separation · examples</h1><p>Open these files locally; no server, network, or package installation is needed.</p><p><a href="matrix.html">14 × 7 model matrix</a> · <a href="evidence.html">Experimental evidence ledger</a></p><div class="notice">Native model results and conditional extensions are separate. A populated cell is not necessarily a prediction from its column alone. All sixteen ontology profiles are visible for each experiment; physical realizability is not presumed.</div><h2>Build your own experiment</h2><p><a href="recipe-comparison.html">Checked recipe comparison</a> · <a href="two-qubit-comparison.html">Two-qubit Bell recipes</a> · <a href="local-friendliness-protocol.html">LF read-or-reverse protocol</a> · <a href="record-access.html">Record-access separation</a> · <a href="model-classes.html">Model-class membership and exclusion</a> · <a href="partial-leakage.html">Partial-leakage robustness study</a> · <a href="../docs/MODEL_CLASS_GUIDE.md">Model-class guide</a> · <a href="../docs/RECORD_ACCESS_GUIDE.md">Record-access guide</a> · <a href="../docs/LF_PROTOCOL_GUIDE.md">LF protocol guide</a> · <a href="../docs/TWO_QUBIT_GUIDE.md">Two-qubit guide</a> · <a href="../docs/START_HERE.md">Create your first experiment</a> · <a href="../docs/GLOSSARY.md">Glossary</a> · <a href="bell-law-study.html">Bell law package and exclusion</a> · <a href="../docs/ADD_A_SCENARIO.md">Add your own scenario</a> · <a href="../docs/PHYSICIST_GUIDE.md">Physicist guide</a> · <a href="operational-results.html">Operational assumptions and formal results</a> · <a href="ruled-out-models.html">Ruled-out model classes</a> · <a href="PhysicistWorkflow.lean">Editable experiments</a></p><h2>From access to a statistical decision</h2><p><a href="environment-access.html">1. Laboratory and environment</a> · <a href="environment-discrimination.html">2. Whole-class discrimination and a concrete witness</a> · <a href="finite-shot.html">3. Prospective finite-shot test</a> · <a href="partial-environment.html">4. Partial-environment threshold benchmark</a></p><h2>Experiment and ontology views</h2><ul>'+''.join(links)+'</ul>'), encoding='utf-8')
