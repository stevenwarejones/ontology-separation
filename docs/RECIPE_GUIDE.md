# Understand the recipe example

Use [Getting started](START_HERE.md) to create and run your first study.
This companion explains the code, physics and proof connection.
