...
-- Elaborate the exact certificates sequentially to bound peak memory.
...
private theorem totalsQ2 : ∀ e : Early,
  ...
  intro e
  fin_cases e <;> with_unfolding_all decide +kernel
...
private theorem abd_matches_q2 :
  ...
  intro x y ww a b d
  rw [← ForcedSignalingLC4Witness.seed_abd_matches]
...
private theorem acd_matches_q2 :
  ...
  intro x z ww a c d
  rw [← ForcedSignalingLC4Witness.seed_acd_matches]
