...
theorem effect_equivalence : (kraus false).conjTranspose * kraus false =
  ...
  ext i j
  cases i <;> cases j <;>
    norm_num [Complex.star_def, map_ofNat, kraus, pathP, Matrix.diagonal, Matrix.mul_apply, Matrix.conjTranspose_apply,
      Fintype.sum_bool, Matrix.one_apply]
...
theorem channel_equivalence (X : Matrix Bool Bool ℂ) :
  ...
  ext i j
  cases i <;> cases j <;>
    norm_num [Complex.star_def, map_ofNat, kraus, pathZ, Matrix.diagonal, Matrix.mul_apply, Matrix.conjTranspose_apply,
